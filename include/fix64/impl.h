...
#include <stdint.h>
    ...
    static inline uint64_t fix64_impl_add_u128(uint64_t x_hi, uint64_t x_lo, uint64_t y_hi, uint64_t y_lo, uint64_t *hi) {
        __extension__ unsigned __int128 res =
            (((unsigned __int128)x_hi << 64) | x_lo) + (((unsigned __int128)y_hi << 64) | y_lo);
        *hi = res >> 64;
        return res;
    }
    static inline uint64_t fix64_impl_add_i128(int64_t x_hi, uint64_t x_lo, int64_t y_hi, uint64_t y_lo, int64_t *hi) {
        __extension__ __int128 res =
            (((__int128)x_hi << 64) | x_lo) + (((__int128)y_hi << 64) | y_lo);
        *hi = res >> 64;
        return res;
    }
    static inline uint64_t fix64_impl_sub_u128(uint64_t x_hi, uint64_t x_lo, uint64_t y_hi, uint64_t y_lo, uint64_t *hi) {
        __extension__ unsigned __int128 res =
            (((unsigned __int128)x_hi << 64) | x_lo) - (((unsigned __int128)y_hi << 64) | y_lo);
        *hi = res >> 64;
        return res;
    }
    static inline uint64_t fix64_impl_sub_i128(int64_t x_hi, uint64_t x_lo, int64_t y_hi, uint64_t y_lo, int64_t *hi) {
        __extension__ __int128 res =
            (((__int128)x_hi << 64) | x_lo) - (((__int128)y_hi << 64) | y_lo);
        *hi = res >> 64;
        return res;
